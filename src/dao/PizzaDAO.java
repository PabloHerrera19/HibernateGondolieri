...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/**
	 * Método que comprueba si existe una Pizza en la base de datos a través del nombre.
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public List<Pizza> listarPizzasQueContienenUnIngrediente(Ingrediente ingrediente) {
		return session.createQuery("select p from Pizza p join p.ingredientes i where i.codigoIngrediente = ?")
				.setInteger(0, ingrediente.getCodigoIngrediente())
				.list();
	}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	public List<Pizza> listadoPizzasDisponibles() {
		return session.createQuery("select p from Pizza p where p.disponible = ?")
				.setBoolean(0, true)
				.list();
	}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public List<Pizza> listadoPizzaEIngredientes(Pizza pizza) throws GondolieriException {
		return session
				.createQuery("select p.ingredientes from Pizza p where p.codigoPizza = ?")
				.setInteger(0, pizza.getCodigoPizza())
				.list();
	}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
